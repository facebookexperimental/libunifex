...
in-flight sender-based async operations as an extension to P0443R14.
...
While P0443R14 provides the ability for an async operation to complete with an empty
...
* Impacts on the algorithms proposed in [P1897](https://wg21.link/P1897) which
  should be updated to support cancellation.

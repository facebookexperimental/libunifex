...
class async_mutex_test : public ::testing::Test {
public:
...
TEST_F(async_mutex_test, cancel_awaiting) {
...
TEST_F(async_mutex_test, cancel_running) {
...
TEST_F(async_mutex_test, cancel_awaiting_middle) {
  bool first_acquired, first_finished, second_acquired, second_finished,
...
TEST_F(async_mutex_test, cancel_early) {
...
TEST_F(async_mutex_test, cancel_awaiting_early) {
  bool first_acquired, first_finished, second_acquired, second_finished,
      second_cancelled;

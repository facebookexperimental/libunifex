...
private:
  ...
  using deactivate_t = void(*)(final_op_union_t&) noexcept;
...
public:
  ...
  template(
    ...
    typename FinalReceiver = final_receiver_type<member_t<Sender, Source>, Func, Receiver>)

...
Ret _vtable_invoke(
  ...
  static_assert(!NoExcept || noexcept(Ret(((CPO&&) cpo)(
...
struct vtable_entry<CPO, Ret(Args...) noexcept> {
  ...
  static constexpr vtable_entry create() noexcept {
    return vtable_entry{&_vtable_invoke<base_cpo_t<CPO>, T, true, Ret, Args...>};
  }
...
struct vtable_entry<CPO, Ret(Args...)> {
  ...
  template <typename T>
  static constexpr vtable_entry create() noexcept {
    return vtable_entry{&_vtable_invoke<base_cpo_t<CPO>, T, false, Ret, Args...>};
  }

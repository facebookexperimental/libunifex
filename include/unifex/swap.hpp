...
namespace _swap {
    ...
    UNIFEX_INLINE_VAR constexpr bool is_adl_swappable_v =
...
namespace _swap_cpo {
UNIFEX_INLINE_VAR constexpr _swap::_fn swap {};
} // namespace _swap_cpo
using _swap_cpo::swap;

template <typename, typename, typename>
UNIFEX_INLINE_VAR constexpr bool is_swappable_with_v = false;

template <typename T, typename U>
UNIFEX_INLINE_VAR constexpr bool is_swappable_with_v<
    T, U, decltype(swap(static_cast<T&&(*)()noexcept>(nullptr)(),
                        static_cast<U&&(*)()noexcept>(nullptr)()))> = true;

template <typename, typename, typename>
UNIFEX_INLINE_VAR constexpr bool is_nothrow_swappable_with_v = false;

template <typename T, typename U>
UNIFEX_INLINE_VAR constexpr bool is_nothrow_swappable_with_v<
    T, U, decltype(swap(static_cast<T&&(*)()noexcept>(nullptr)(),
                        static_cast<U&&(*)()noexcept>(nullptr)()))> = 
    noexcept(swap(static_cast<T&&(*)()noexcept>(nullptr)(),
                  static_cast<U&&(*)()noexcept>(nullptr)()));
} // namespace unifex

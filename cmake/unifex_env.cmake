...
# Require a cmake and compiler with at least C++17
set(latest_cxx_std)
...
if(NOT latest_cxx_std)
  foreach(feature ${CMAKE_CXX_COMPILE_FEATURES})
    if(feature STREQUAL "cxx_std_17")
      set(latest_cxx_std "17")
    endif()
  endforeach()
endif()
if(NOT latest_cxx_std OR latest_cxx_std LESS 17)
  message(FATAL_ERROR "FATAL: To build this project requires a compiler and cmake supporting C++17 or later, this compiler and cmake claims to only support C++ ${latest_cxx_std}")
endif()

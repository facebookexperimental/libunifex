...
if(find_final)
    set(CMAKE_REQUIRED_FLAGS "${_CXX_COROUTINES_STDLIB}")
...
if(CXX_COROUTINES_HAVE_COROUTINES)
    ...
    if(can_link)
        ...
        if (NOT "x${_CXX_COROUTINES_STDLIB_LIB}" STREQUAL "x")
            target_link_libraries(std::coroutines INTERFACE ${_CXX_COROUTINES_STDLIB_LIB})
        endif()
        set(_found TRUE)

...
# GCC 10.2 and earlier to also too broken to support.
if (UNIFEX_CXX_COMPILER_MSVC)
    set(_UNIFEX_COROUTINES_TOO_BUGGY TRUE)
elseif(UNIFEX_CXX_COMPILER_GCC AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS 10.3.0)
    set(_UNIFEX_COROUTINES_TOO_BUGGY TRUE)
else()
    set(_UNIFEX_COROUTINES_TOO_BUGGY FALSE)
endif()

if(CXX_COROUTINES_HAVE_COROUTINES AND NOT _UNIFEX_COROUTINES_TOO_BUGGY)
